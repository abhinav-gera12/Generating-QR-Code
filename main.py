...
image = qr.make("https://github.com/abhinav-gera12")                         # image is a variable and make is a function that i am using from the qrcode library which generates the qr code and get stored in the variable.
